		...
		enum  spi_commands cmd, const unsigned long arg)
{
	...
	switch(cmd)
	{
	  ...
	  case Cmd_enspi:
	  {
		SPI_REG(SPIPC0) = (Sel_chip0 == (enum  spi_selchip)arg)?0x00000E01:0x00000E02;
		tmp = 0;
	  }
	  break;
	  case Cmd_dataformat:
